    ...
    <div className={`min-h-screen pt-20 relative overflow-hidden transition-colors ${
        ...
        <div className={`absolute inset-0 flex flex-col items-center justify-center px-4 sm:px-6`}>
          ...
          >
            <h1 className={`text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 md:mb-4 drop-shadow-2xl text-white`}>
              The BR!NK <span className="text-[#D4AF37] drop-shadow-lg">Solution</span>
            </h1>
            <p className={`text-sm sm:text-base md:text-lg max-w-2xl mx-auto drop-shadow-lg text-white`}>
              Transformational experiences designed to empower the next generation
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 relative z-10">
        ...
        >
                  ...
                  >
                    <div className="flex items-start space-x-6">
                      ...
                      <div className="flex-1">
                        ...
                        <p className={`text-lg leading-relaxed ${isDarkMode ? "text-[#F5F5F5]" : "text-white/90"}`}>
          ...
          >
            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-center">Why BR!NK?</h2>
            <p className="text-base md:text-lg text-center max-w-3xl mx-auto leading-relaxed">
